...
"""
Created on Fri Feb  7 18:04:33 2020
...
dataset = pd.read_csv('AB186_Circuit_raw.csv')#,usecols=[*range(6),*range(12,18),48]))
...
# _, X_test, _, y_test = train_test_split(X_test, y_test, test_size = 0.25 )
...
#%% Load The Model
model = pickle.load(open('C:/Users/Abdullah/Desktop/SVM_Model/model.pkl', 'rb'))
result_train = model.score(X_train, y_train)
result_test = model.score(X_test, y_test)
print("Accuracy of train_set is : "+ format(result_train*100,'.3f') +' %')
print("Accuracy of test_set is : "+ format(result_test*100,'.3f') +' %')
